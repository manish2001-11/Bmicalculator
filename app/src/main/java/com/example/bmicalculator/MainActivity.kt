...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageBoy= findViewById<ImageView>(R.id.boy_img)
        val imageGirl =findViewById<ImageView>(R.id.woman)
        ...
        imageBoy.setOnClickListener {
            ...
            imageGirl.setImageResource(R.drawable.g)
        }
        imageGirl.setOnClickListener {
            imageGirl.setImageResource(R.drawable.woman)
            imageBoy.setImageResource(R.drawable.b)
        }
     ...
     /*   if(weight.text.isNotEmpty()){
        ...
        if(height.text.toString().isNotEmpty()){
            weightValue =(height.text.toString().toDouble() / 100)
        }
*/
        calculateButton.setOnClickListener {
            var  weightValue =  weight.text.toString().toDouble()
            var  heightValue =(height.text.toString().toDouble()/100)

            if (weightValue >0 && heightValue >0){
                val bmiValue = String.format("%.1f",weightValue/heightValue.pow(2))
                ...
                Toast.makeText(this,"Please input Weight value greater then 0.0" ,Toast.LENGTH_SHORT).show()
        }
